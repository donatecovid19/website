...
const ASIA = [
  ...
  {
    name: "Japan",
    url: "https://www.plan-international.jp/news/info/20200331_21914/",
  },
  { name: "India (Give)", url: "http://bit.ly/donateGIcovid19" },
  { name: "India (Rapid Response)", url: "http://bit.ly/donateINDcovid19" },
  {
    name: "Indonesia (Dompet Dhuafa)",
    url: "https://donasi.dompetdhuafa.org/bersamalawancorona/",
  },
  {
    name: "Indonesia (Unicef Indonesia)",
    url: "http://bit.ly/donateINcovid19",
  },
  { name: "Korea", url: "https://www.plankorea.or.kr/news/event/view/5043" },
  {
    name: "Malayasia (Kitajagakita)",
    url: "https://kitajagakita.com/pages/submit-an-initiative-for-listing",
  },
  { name: "Malaysia (Masterlist)", url: "http://bit.ly/donateMYcovid2019" },
  {
    name: "Malaysia (MERCY)",
    url: "https://www.mercy.org.my/donate/wakaf-covid19/",
  },
  ...
  {
    name: "Philippines (Project Pearls)",
    url: "https://www.projectpearls.org/donate/",
  },
...
const EUROPE = [
  ...
  {
    name: "France",
    url: "https://formulaire.plan-international.fr/covid19/~mon-don",
  },
  { name: "Germany (Red Cross)", url: "http://bit.ly/donateDEcovid19" },
  {
    name: "Germany (Maecenata)",
    url: "https://web.maecenata.eu/spenden?fb_item_id_fix=27166/",
  },
  { name: "Italy (Red Cross)", url: "http://bit.ly/donateITcovid19" },
  {
    name: "Italy (Protezione Civile)",
    url:
      "http://www.protezionecivile.gov.it/attivita-rischi/rischio-sanitario/emergenze/coronavirus",
  },
  {
    name: "Italy (Regione del Veneto)",
    url: "https://www.regione.veneto.it/article-detail?articleId=4335623",
  },
  { name: "Netherlands (Red Cross)", url: "http://bit.ly/donateNLcovid19" },
  {
    name: "Netherlands (Plan International)",
    url: "https://www.planinternational.nl/forms/stop-verspreiding-coronavirus",
  },
...
const NORTH_AMERICA = [
  ...
  {
    name: "Boone, IA",
    url: "https://www.redcross.org/donate/donation.html/?donamt=0",
  },
  {
    name: "Chicago, IL (Chicago's Food Bank)",
    url: "http://bit.ly/donateCILcovid19",
  },
  {
    name: "Chicago, IL (Community Fund)",
    url: "https://www.chicagocovid19responsefund.org/",
  },
  {
    name: "Chicago, IL (Feeding America)",
  ...
  {
    name: "New York City, NY (CityMeals)",
    url: "http://bit.ly/donateNYcovid19",
  },
  {
    name: "New York City, NY (Mount Sinai)",
    url:
      "https://giving.mountsinai.org/site/Donation2;jsessionid=00000000.app216a?idb=1183495007&df_id=2021&mfc_pref=T&2021.donation=form1&NONCE_TOKEN=7E563239AF1564122679453358A75C21&utm_campaign=flowcodecovidgift&utm_source=flowcode&set.custom.appeal1=COVIDFLOWCODE&utm_medium=flowcode",
  },
  {
    name: "New York City, NY (NYC)",
    url: "https://www1.nyc.gov/site/fund/donate/donate.page",
  },
...
const CENTRAL_AMERICA = [
  ...
  {
    name: "Mexico",
    url: "https://www.cruzrojamexicana.org.mx/causa/detalle/34",
  },
];

...
const AFRICA = [
  {name:"Uganda", url:'http://bit.ly/donateUGcovid19'},
]

const OCEANIA = [
  {name:"Australia", url:'http://bit.ly/donateAUScovid19'},
]

const MIDDLE_EAST = [
  {name:"UAE", url:'http://bit.ly/donateAEcovid19'},
]
  ...
  return (
    <div className='home'>
      ...
      <div class='grid'>
        ...
        {/* TODO: Why does it show up as South America first? */}
        <Box name = "North America" list_of_links = {NORTH_AMERICA} className = "northamerica" />
